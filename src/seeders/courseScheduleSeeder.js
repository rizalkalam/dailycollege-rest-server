...
const seedCourseSchedules = async () => {  
    try {  
        ...
        const courseSchedules = [  
            { day: 'Senin', subject: 'Matematika', time: '08:00 - 10:00', location: 'Ruang A', user_id: user_1._id },  
            { day: 'Selasa', subject: 'Fisika', time: '10:00 - 12:00', location: 'Ruang B', user_id: user_1._id },  
            { day: 'Rabu', subject: 'Kimia', time: '13:00 - 15:00', location: 'Ruang C', user_id: user_1._id },  
            { day: 'Kamis', subject: 'Biologi', time: '08:00 - 10:00', location: 'Ruang D', user_id: user_1._id },  
            { day: 'Jumat', subject: 'Sejarah', time: '10:00 - 12:00', location: 'Ruang E', user_id: user_1._id },  
        ];  
  
        // Data contoh untuk user_2  
        const courseSchedulesUser2 = [  
            { day: 'Senin', subject: 'Geografi', time: '08:00 - 10:00', location: 'Ruang F', user_id: user_2._id },  
            { day: 'Selasa', subject: 'Ekonomi', time: '10:00 - 12:00', location: 'Ruang G', user_id: user_2._id },  
            { day: 'Rabu', subject: 'Seni', time: '13:00 - 15:00', location: 'Ruang H', user_id: user_2._id },  
            { day: 'Kamis', subject: 'Olahraga', time: '08:00 - 10:00', location: 'Ruang I', user_id: user_2._id },  
            { day: 'Jumat', subject: 'Bahasa Inggris', time: '10:00 - 12:00', location: 'Ruang J', user_id: user_2._id },  
        ];  
